...
@pytest.mark.parametrize(
    ...
    [
        ("low", "❯❯❯ user❯Hello"),
        ("high", "❯❯❯ assistant❯Reasoning Effort: Absolute maximum"),
        ("max", "❯❯❯ assistant❯Reasoning Effort: Beyond maximum"),
    ],
)
def test_deepseek_v4_renders_0731_reasoning_effort_prompts(
    ...
    assert prompt.endswith("❯❯❯ assistant❯ thinking")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            '❯❯❯ parameter name="target" string="true">cache',
        ),
        (
            {"name": "refresh", "arguments": {"target": "cache"}},
            '❯❯❯ parameter name="target" string="true">cache',
...
def test_deepseek_v4_renders_openai_history_tool_call_with_null_arguments():
    ...
    assert '<❯❯❯ invoke name="refresh">' in prompt
